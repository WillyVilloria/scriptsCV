...
class Documento:
    ...
    def __numero_pagina(self, footer_para):
        ...
        footer_para.add_run(self.translate.translate("Página ", dest='en').text)
        # Campo PAGE
    ...
    def experiencia_prof(self):
        ...
        exp1.add_run(self.translate.translate("Desarrollador / Analista - Grupo Tecnológico (2022 - Actualidad)", dest='en').text).bold = True
        experiencia = [
            ...
            "Visualización de resultados y KPIs con Power BI, QlickView y Looker.",
        ...
        exp2.add_run(self.translate.translate("Jefe de Operaciones / Servicio - UTE ESE CLECE - Gas Natural Fenosa (2012 - 2022)", dest='en').text).bold = True
        operaciones = [
        ...
        exp3.add_run(self.translate.translate("Responsable de Proyectos e Instalaciones - Energía y Servicios Energéticos Plus S.A.\n\t", dest='en').text).bold = True
    ...
    def formacion(self):
        ...
        for item in formacion:
            ...
            run = bullet.add_run(f"•\t{self.translate.translate(item, dest='en').text}")
            run.bold = True
            bullet.paragraph_format.left_indent = Pt(20)         # sangría para alinear con el texto
            bullet.paragraph_format.first_line_indent = Pt(-18)  # primera línea “sale” la viñeta
            bullet.paragraph_format.space_after = Pt(0)
        ...
        self.doc.add_paragraph(self.translate.translate("Otros cursos: Máster en Gestión de Calidad y Medio Ambiente, Técnico de Prevención de Riesgos Laborales, Autocad, Soldadura técnica.", dest='en').text)
    ...
    def guardar(self):
        # Guardar documento
        output_path_visual = f"../CV/LECV_Miguel_Angel_Lorenzo_Villoria_Data_Visual{self.fecha.day}.docx"
